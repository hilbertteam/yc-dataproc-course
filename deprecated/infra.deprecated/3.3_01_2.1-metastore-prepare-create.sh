...
envsubst < templates/s3-data-sa-policy.json > ./temp/s3-data-sa-policy.json
# Назначаем сервисному аккаунту policy на бакет
yc storage bucket update --name $S3_BUCKET_NAME --policy-from-file ./temp/s3-data-sa-policy.json
